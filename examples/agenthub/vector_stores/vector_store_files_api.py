...
create_result = oci_openai_client.vector_stores.files.create(
...
list_result = oci_openai_client.vector_stores.files.list(
    vector_store_id=VECTOR_STORE_ID,
)
print("\nFiles:", list_result)

# Retrieve vector store file
retrieve_result = oci_openai_client.vector_stores.files.retrieve(
    vector_store_id=VECTOR_STORE_ID,
    file_id=FILE_ID,
)
...
update_result = oci_openai_client.vector_stores.files.update(
    vector_store_id=VECTOR_STORE_ID,
    file_id=FILE_ID,
...
delete_result = oci_openai_client.vector_stores.files.delete(
    vector_store_id=VECTOR_STORE_ID,
    file_id=FILE_ID,
)
